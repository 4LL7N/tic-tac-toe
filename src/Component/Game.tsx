...
function Game(){
    ...
    return(
        <>
            <div className={`  bg-[#1A2A33] pl-[24px] pr-[23px] md:pl-[154px] md:pr-[154px] lg:pr-[450px] lg:pl-[530px] pt-[24px] md:pt-[201px] lg:pt-[139px] pb-[127px] md:pb-[200px] lg:pb-[138px] min-h-[100vh] overflow-hidden `} >
                <header className="flex items-center justify-between w-[100%] mb-[64px] md:mb-[20px] lg:w-[460px]" >
                    ...
                    <div className="flex items-center gap-[8px] md:gap-[13px] px-[15px] md:px-[30px] py-[10px] md:py-[15px] ml-[-30px] bg-[#1F3641] shadow-[0px_4px_0px_0px_#10212A] rounded-[5px] md:w-[140px] md:h-[52px]  " >
                        <img className="w-[16px] md:w-[20px] h-[16px] md:h-[20px] " src={context.playWith?"/images/cross-chosen.svg":"/images/oval-chosen.svg"}/>
                        <p className="text-[14px] md:text-[16px] text-[#A8BFC9] font-bold tracking-[0.875px] md:tracking-[1px] " >TURN</p>
                    </div>
                    <div className="flex px-[16px]  py-[14px]  bg-[#A8BFC9] shadow-[0px_4px_0px_0px_#6B8997] rounded-[10px] " onClick={() => context.setRestart(true)} >
                ...
                <section>
                    ...
                    <div className=" flex justify-between mt-[24px] md:mt-[28px] lg:w-[460px]" >
                        <div className=" w-[96px] md:w-[140px] h-[64px] md:h-[72px] flex flex-col items-center justify-center bg-[#31C3BD] rounded-[10px] " ><p className="text-[14px] text-[#1A2A33] font-medium tracking-[0.875px] " >X {params.game == "sologame"?"(YOU)":"(P2)" }</p><p className="text-[20px] md:text-[24px] text-[#1A2A33] font-bold tracking-[1.25px] tracking-[1.5px] " >{P1.current}</p></div>
                        <div className=" w-[96px] md:w-[140px] h-[64px] md:h-[72px] flex flex-col items-center justify-center bg-[#A8BFC9] rounded-[10px] " ><p className="text-[14px] text-[#1A2A33] font-medium tracking-[0.875px] " >TIES</p><p className="text-[20px] md:text-[24px] text-[#1A2A33] font-bold tracking-[1.25px] tracking-[1.5px] " >{tie.current}</p></div>
                        <div className=" w-[96px] md:w-[140px] h-[64px] md:h-[72px] flex flex-col items-center justify-center bg-[#F2B137] rounded-[10px] " ><p className="text-[14px] text-[#1A2A33] font-medium tracking-[0.875px] " >O {params.game == "sologame"?"(CPU)":"(P1)" }</p><p className="text-[20px] md:text-[24px] text-[#1A2A33] font-bold tracking-[1.25px] tracking-[1.5px] " >{P2.current}</p></div>
                    </div>
                </section>
            </div>
            <div className={` ${context.Restart||context.winner?"block":"hidden"} absolute top-[0] bg-[#000000] bg-opacity-50 h-[100vh] w-[100vw] `} />
            <Restart/>
            <Winner/>
        </>
    )
